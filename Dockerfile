...
ADD https://apt.corretto.aws/corretto.key                       /etc/apt/keyrings/corretto.asc
...
RUN install -m 0755 -d /etc/apt/keyrings  \
    ...
    && echo "deb [signed-by=/etc/apt/keyrings/corretto.asc] https://apt.corretto.aws stable main" | tee /etc/apt/sources.list.d/corretto.list > /dev/null \
